					...
					<div className="about-copy">
						...
						<Reveal delay={0.15}>
							<p className="about-text">
								I enjoy transforming ideas into digital experiences. By blending
								design and development, I create websites that are visually
								engaging, functional, and enjoyable to interact with. <br />
							</p>
						</Reveal>
						...
						<Reveal delay={0.2} className="about-annot">
							...
							<span className="about-annot-text handnote">
								the profile shot, obviously
							</span>
